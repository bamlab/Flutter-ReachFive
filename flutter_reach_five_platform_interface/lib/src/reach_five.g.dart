...
class ReachFiveHostApi {
  ...
  Future<ReachFiveConfigInterface> initialize(
    ...
    final List<Object?>? replyList =
        await channel.send(<Object?>[arg_reachFiveKey]) as List<Object?>?;
    if (replyList == null) {
      ...
      return (replyList[0] as ReachFiveConfigInterface?)!;
    }
  }
  ...
  Future<AuthTokenInterface> signup(SignupRequestInterface arg_request) async {
    ...
    if (replyList == null) {
      ...
      return (replyList[0] as AuthTokenInterface?)!;
    }
  }
  ...
  Future<ProfileInterface> getProfile(
    ...
    if (replyList == null) {
      ...
      return (replyList[0] as ProfileInterface?)!;
    }
  }
