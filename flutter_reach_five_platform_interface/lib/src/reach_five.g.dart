...
// ignore_for_file: public_member_api_docs, non_constant_identifier_names, avoid_as, unused_import, unnecessary_parenthesis, prefer_null_aware_operators, omit_local_variable_types, unused_shown_name, unnecessary_import, lines_longer_than_80_chars
import 'dart:async';
...
class ReachFiveHostApi {
  ...
  Future<ReachFiveConfigInterface> initialize(
    ReachFiveConfigInterface arg_config,
  ) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
      'dev.flutter.pigeon.ReachFiveHostApi.initialize',
      codec,
