...
/// Wrapper for ProviderCreatorTypeInterface to allow for nullability.
@interface ProviderCreatorTypeInterfaceBox : NSObject
@property(nonatomic, assign) ProviderCreatorTypeInterface value;
...
/// Wrapper for ProfileAddressTypeInterface to allow for nullability.
@interface ProfileAddressTypeInterfaceBox : NSObject
@property(nonatomic, assign) ProfileAddressTypeInterface value;
...
@property(nonatomic, copy) NSString * unauthorizedRefreshToken;
@end
...
@property(nonatomic, copy) NSArray<ProviderCreatorInterface *> * providerCreators;
@end
...
@property(nonatomic, copy) NSArray<NSString *> * providers;
@end
...
@property(nonatomic, strong, nullable) ProfileAddressTypeInterfaceBox * addressType;
...
@property(nonatomic, copy, nullable) NSString * company;
@property(nonatomic, copy, nullable) NSArray<ProfileAddressInterface *> * addresses;
@property(nonatomic, copy, nullable) NSString * locale;
@property(nonatomic, copy, nullable) NSString * bio;
@property(nonatomic, copy, nullable) NSDictionary<NSString *, id> * customFields;
@property(nonatomic, copy, nullable) NSDictionary<NSString *, ConsentInterface *> * consents;
...
@property(nonatomic, copy, nullable) NSArray<NSString *> * scope;
...
@property(nonatomic, copy, nullable) NSArray<NSString *> * origins;
@property(nonatomic, copy, nullable) NSArray<NSString *> * devices;
...
@property(nonatomic, copy, nullable) NSArray<NSString *> * verified;
@property(nonatomic, copy, nullable) NSArray<NSString *> * unverified;
@end
...
@property(nonatomic, copy, nullable) NSString * picture;
@property(nonatomic, copy, nullable) NSString * externalId;
@property(nonatomic, copy, nullable) NSArray<NSString *> * authTypes;
...
extern void SetUpReachFiveHostApi(id<FlutterBinaryMessenger> binaryMessenger, NSObject<ReachFiveHostApi> *_Nullable api);
