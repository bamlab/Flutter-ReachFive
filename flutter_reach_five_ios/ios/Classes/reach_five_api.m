...
+ (nullable LoginWithProviderRequestInterface *)nullableFromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
+ (GetProfileRequestInterface *)fromMap:(NSDictionary *)dict;
+ (nullable GetProfileRequestInterface *)nullableFromMap:(NSDictionary *)dict;
- (NSDictionary *)toMap;
@end
...
+ (nullable GetProfileRequestInterface *)nullableFromMap:(NSDictionary *)dict { return (dict) ? [GetProfileRequestInterface fromMap:dict] : nil; }
- (NSDictionary *)toMap {
  return @{
    @"reachFiveKey" : (self.reachFiveKey ? [self.reachFiveKey toMap] : [NSNull null]),
    @"authToken" : (self.authToken ? [self.authToken toMap] : [NSNull null]),
...
- (nullable id)readValueOfType:(UInt8)type 
{
  switch (type) {
    ...
    case 133:     
      return [GetProfileRequestInterface fromMap:[self readValue]];
...
- (void)writeValue:(id)value 
{
  ...
  if ([value isKindOfClass:[GetProfileRequestInterface class]]) {
    [self writeByte:133];
    [self writeValue:[value toMap]];
  } else 
