...
public class ReachFiveApi {
  ...
  public static class ErrorCodesInterface {
    ...
    public @NonNull String getEmailAlreadyInUseCode() { return emailAlreadyInUseCode; }
    ...
    public @NonNull String getInvalidEmailOrPasswordCode() { return invalidEmailOrPasswordCode; }
    ...
    public @NonNull String getInvalidVerificationCode() { return invalidVerificationCode; }
    ...
    static @NonNull ErrorCodesInterface fromMap(@NonNull Map<String, Object> map) {
      ...
      Object emailAlreadyInUseCode = map.get("emailAlreadyInUseCode");
      pigeonResult.setEmailAlreadyInUseCode((String)emailAlreadyInUseCode);
      Object invalidEmailOrPasswordCode = map.get("invalidEmailOrPasswordCode");
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class LoginWithProviderRequestInterface {
    private @NonNull ReachFiveKeyInterface reachFiveKey;
    public @NonNull ReachFiveKeyInterface getReachFiveKey() { return reachFiveKey; }
    public void setReachFiveKey(@NonNull ReachFiveKeyInterface setterArg) {
      if (setterArg == null) {
    ...
    public @NonNull String getProvider() { return provider; }
    ...
    public @NonNull String getOrigin() { return origin; }
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class GetProfileRequestInterface {
    private @NonNull ReachFiveKeyInterface reachFiveKey;
    public @NonNull ReachFiveKeyInterface getReachFiveKey() { return reachFiveKey; }
    public void setReachFiveKey(@NonNull ReachFiveKeyInterface setterArg) {
      if (setterArg == null) {
    ...
    /**Constructor is private to enforce null safety; use Builder. */
    private GetProfileRequestInterface() {}
    public static final class Builder {
      private @Nullable ReachFiveKeyInterface reachFiveKey;
      public @NonNull Builder setReachFiveKey(@NonNull ReachFiveKeyInterface setterArg) {
        this.reachFiveKey = setterArg;
    ...
    static @NonNull GetProfileRequestInterface fromMap(@NonNull Map<String, Object> map) {
  ...
  private static class ReachFiveHostApiCodec extends StandardMessageCodec {
    ...
    protected Object readValueOfType(byte type, @NonNull ByteBuffer buffer) {
      switch (type) {
        ...
        case (byte)133:         
          return GetProfileRequestInterface.fromMap((Map<String, Object>) readValue(buffer));
    ...
    protected void writeValue(@NonNull ByteArrayOutputStream stream, Object value)     {
      ...
      if (value instanceof GetProfileRequestInterface) {
        stream.write(133);
        writeValue(stream, ((GetProfileRequestInterface) value).toMap());
      } else 
      ...
      } else 
{
  ...
  public interface ReachFiveHostApi {
    ...
    void getProfile(@NonNull GetProfileRequestInterface request, Result<ProfileInterface> result);
    ...
    static void setup(BinaryMessenger binaryMessenger, ReachFiveHostApi api) {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ReachFiveHostApi.loginWithProvider", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ReachFiveHostApi.getProfile", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
      ...
      {
        BasicMessageChannel<Object> channel =
            new BasicMessageChannel<>(binaryMessenger, "dev.flutter.pigeon.ReachFiveHostApi.requestPasswordReset", getCodec());
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            Map<String, Object> wrapped = new HashMap<>();
            try {
