...
class MFAApi {
  ...
  Future<Response<void>> deleteEmailCredential({
    ...
    final _path = r'/identity/v1/mfa/credentials/emails';
  ...
  /// Returns a [Future]
  /// Throws [DioError] if API call or serialization fails
  Future<Response<void>> deletePhoneNumberCredential({
    required String authorization,
    DeletePhoneNumberCredentialRequest? deletePhoneNumberCredentialRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/identity/v1/mfa/credentials/phone-numbers';
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        r'Authorization': authorization,
